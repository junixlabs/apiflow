import type { ApiMapFile, Confidence } from './apimap';
import { bePartial, unresolvedKinds } from './apimap';
...
// cm:edge contract -> packages/cli/src/view/panes.ts — the per-row micro-bar renders exactly this split.
