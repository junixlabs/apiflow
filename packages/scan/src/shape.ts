// cm:edge lockstep -> packages/map/src/shape.ts — the types live with the format, the derivation
// lives here. Re-exported so every scanner keeps importing ShapeField from one place.
import type { ShapeType, ShapeField } from '@junixlabs/apiflow-map';

export type { ShapeType, ShapeField };
